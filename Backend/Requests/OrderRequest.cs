...
namespace Backend.Request
{
    ...
    public class OrderItemUpdateRequest
    {
        ...
        public required string ItemUid { get; set; } // ItemUid is required for identifying the item in the order

        [JsonProperty("amount")]
        public required int Amount { get; set; } // The amount is being updated here
    }
